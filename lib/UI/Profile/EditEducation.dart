...
class _EditEducationScreenState extends State<EditEducationScreen> {
  ...
  void initState() {
    ...
    StudyController = TextEditingController(text: widget.study);
    ...
    setState(() {
      ...
      startDate = truncateString(widget.start_month.toString()) +
          widget.start_year.toString();
      endDate = truncateString(widget.end_month.toString()) +
          widget.end_years.toString();
    });
  }
