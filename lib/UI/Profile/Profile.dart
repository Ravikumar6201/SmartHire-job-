...
import 'package:job_application/UI/JobApply/ResumeUploader.dart';
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                            ...
                            children: [
                              Row(
                                mainAxisAlignment:
                                    MainAxisAlignment.spaceBetween,
                                children: [
                                  _buildSectionTitle('Resume', isTablet),
                                  InkWell(
                                    onTap: () {
                                      Navigator.push(
                                        context,
                              ...
                              ListView.builder(
                                ...
                                shrinkWrap: true,
                                itemCount: Resumelist.length > 3
                                    ? 3
                                    : Resumelist.length,
                                itemBuilder: (context, index) {
                                  bool isSelected = selectedResumeIndex ==
                                      index; // Check if selected
                                  return Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              ListView.builder(
                                physics: NeverScrollableScrollPhysics(),
                                shrinkWrap: true,
                                itemCount: Expriencelist.length > 2
                                    ? 2
                                    : Expriencelist.length,
                    ...
                    //                       MaterialPageRoute(
                    //                           builder: (context) =>
                    //                               ExprienceListScreen()), // Replace `NewPage` with the page you want to navigate to
                    //                     )..then((_) {
                    //                         UserProfile(); // Call reload after deleting the resume
                    //                       }).catchError((error) {
                    //                         // Handle error if needed
                    ...
                    // _buildSectionTitle('Experience', isTablet),
                    // _buildExperienceRow(
                    //     'Facebook', 'UI Designer', 'June 2020 - Dec 2020', isTablet),
                    // _buildExperienceRow('Instagram', 'UI Designer',
                    //     'April 2019 - June 2019', isTablet),
                    // SizedBox(height: 24),
                    ...
                    // _buildSectionTitle('Education', isTablet),
                    // _buildInfoRow('assets/images/Edit.png', 'BMC Cordelia Bangsa',
                    //     'Bachelor of Science (2017 - 2021)', isTablet),
                    SizedBox(height: 4),
                            ...
                            children: [
                              Row(
                                mainAxisAlignment:
                                    MainAxisAlignment.spaceBetween,
                                children: [
                                  _buildSectionTitle('Skills', isTablet),
                                  Row(
                                    children: [
                                      InkWell(
                                        onTap: () {
                                          ...
                                          //   MaterialPageRoute(
                                          //       builder: (context) =>
                                          //           AddSkillScreen()), // Replace `NewPage` with the page you want to navigate to
                                          // );
                                        },
                                        child: Image.asset(
                                          'assets/images/add-circle.png',
                              ...
                              GridView.builder(
                                gridDelegate:
                                  ...
                                  maxCrossAxisExtent:
                                      100, // Maximum width of each item
                                  crossAxisSpacing: 5,
                                  mainAxisSpacing: 10,
                                  childAspectRatio:
                                      3, // Adjust this ratio for height/width
                                ),
                                physics: NeverScrollableScrollPhysics(),
                                shrinkWrap: true,
                                itemCount: skillList.length > 6
                                    ? 6
                                    : skillList.length, // Take a max of 6 items
                                itemBuilder: (context, index) {
                                  return _buildTag(skillList[index]['skill']);
                                },
                              )
                              ...
                              //   physics: NeverScrollableScrollPhysics(),
                              //   childAspectRatio:
                              //       3, // Ensures the buttons maintain equal height/width ratio
                              //   shrinkWrap: true,
                              //   children: skillList
                              //       .take(
                              //           6) // Take a maximum of 6 items from the list
                              //       .map<Widget>((skill) {
                              //     return _buildTag(skill['skill']);
                              //   }).toList(),
                              // ),
                            ],
                          ),
                            ...
                            children: [
                              Row(
                                mainAxisAlignment:
                                    MainAxisAlignment.spaceBetween,
                                children: [
                                  _buildSectionTitle('Language', isTablet),
                                  Row(
                                    children: [
                                      InkWell(
                                        onTap: () {
                                          Navigator.push(
                                            ...
                                            MaterialPageRoute(
                                                builder: (context) =>
                                                    AddLaguageScreen()), // Replace `NewPage` with the page you want to navigate to
                                          );
                                        },
                                        child: Image.asset(
                                          'assets/images/add-circle.png',
                                      ...
                                      InkWell(
                                        onTap: () {
                                          ...
                                          //   MaterialPageRoute(
                                          //       builder: (context) =>
                                          //           LaguageScreen()), // Replace `NewPage` with the page you want to navigate to
                                          // );
                                        },
                                        child: Image.asset(
                                          'assets/images/Edit.png',
                              ...
                              GridView.count(
                                ...
                                childAspectRatio:
                                    3, // Ensures the buttons maintain equal height/width ratio
                                shrinkWrap: true,
                                children: laguagelist
                                    .take(
                                        6) // Take a maximum of 6 items from the list
                                    .map<Widget>((language) {
                                  return _buildTag(language['lang']);
                                }).toList(),
                              ),
                            ],
                          ),
