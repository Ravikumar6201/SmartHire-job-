...
class JobapplySelectResumeScreen extends StatefulWidget {
  String SelectRemume, jobid;

  @override
  JobapplySelectResumeScreen({required this.SelectRemume, required this.jobid});

  @override
  _JobapplySelectResumeScreenState createState() =>
      _JobapplySelectResumeScreenState();
}

class _JobapplySelectResumeScreenState
    extends State<JobapplySelectResumeScreen> {
  ...
  void _selectResume(int index, String resumeids) {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
          ...
          : Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 8),
                  Text(
                    "When you apply to jobs labeled as “Easy apply”, the’ll appear here",
                                    ...
                                    children: [
                                      Row(
                                        children: [
                                          ...
                                          Column(
                                            ...
                                            children: [
                                              Text(
                                                truncateString(resumelis[index]
                                                    ['file_name']),
                                                style: GoogleFonts.manrope(
                                                    fontWeight: FontWeight.bold,
                                                    fontSize: 12),
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          Radio<int>(
                                            value: index,
                                            groupValue: selectedResumeIndex,
                                            activeColor: ColorConstant.botton,
                                            onChanged: (int? newValue) {
                                              setState(() {
                                                // Update the selected index based on the radio button selection
                                                selectedResumeIndex = newValue;
                                              });
                                              if (newValue != null) {
                                                _selectResume(newValue,
                                                    resumelis[newValue]['id']);
                                              }
                                            },
                                          )
                                          // Checkbox(
                                          //   value: selectedResumeIndex == index,
                                          //   onChanged: (bool? newValue) {
                                          //     setState(() {
                                          //       // Update the selected index based on the checkbox state
                                          //       selectedResumeIndex =
                                          //           newValue == true
                                          //               ? index
                                          //               : null;
                  ...
                  // if (resumelis.isNotEmpty && widget.SelectRemume == "Yes")
                  //   ElevatedButton(
                  //     onPressed: () {
                  //       Navigator.pop(context);
                  //     },
      ...
      bottomNavigationBar: resumelis.isNotEmpty && widget.SelectRemume == "yes"
          ? Padding(
          ...
          : null, // If condition is false, the button won't be displayed
    );
  }
